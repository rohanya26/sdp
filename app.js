...
seedDB();
mongoose.connect("mongodb://localhost/data_hanks", { useNewUrlParser: true ,useUnifiedTopology: true,useCreateIndex: true });
...
app.listen(5500, function() {
    console.log("DataHanks server has started");
})
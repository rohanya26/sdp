...
router.post("/login", passport.authenticate("local", { 
  ...
  failureFlash: true,
successFlash: 'Welcome to Datahanks!' 
}), function(req, res) {
...
router.get("/users/:id", function(req, res) {
    user.findById(req.params.id, function(err, foundUser) {
      ...
      hank.find().where('author.id').equals(foundUser._id).exec(function(err, hanks) {
        if(err) {
          req.flash("error", "Something went wrong.");
          return res.redirect("/");
        }
...
//Edit Profile
router.get("/users/:id/edit", isLoggedIn,checkProfileOwnership, function(req, res) {
